...
public class DebugCommand extends CommandBase {
	...
	public void sql_cmd() {
		...
		ConnectionPool.Stats s = SQL.gameDatabase.getStats();

		CivMessage.send(sender, "ConnectionsRequested: "+s.getConnectionsRequested());
		CivMessage.send(sender,"Free Pool Members: "+s.getTotalFree());
		CivMessage.send(sender,"Leased Pool Members: " +s.getActive());
